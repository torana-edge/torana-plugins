...
var pluginContracts = map[string]pluginContract{
	...
	"decision_router": {hooks: []string{"run_before_request", "run_after_response"},
		permissions: []string{"env.credential_get", "env.emit_metric", "env.http_request", "env.log", "env.meta_get", "env.meta_set", "env.model_capabilities", "env.plugin_config", "env.state_get", "env.state_set", "env.suggest"}},
	...
	"keyword_compactor": {hooks: []string{"run_before_request"},
		permissions:   []string{"env.cache_get", "env.cache_set", "env.emit_metric", "env.host_call.torana_record_savings", "env.model_pricing", "env.plugin_config", "env.shared_cache_get", "ir.tool_results.write"},
