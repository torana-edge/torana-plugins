...
func TestManifestContract(t *testing.T) {
	...
	sort.Strings(got)
	want := []string{"env.credential_get", "env.emit_metric", "env.http_request", "env.log", "env.meta_get", "env.meta_set", "env.model_capabilities", "env.plugin_config", "env.state_get", "env.state_set"}
	if len(got) != len(want) {
